...
def load_blaze_all():
    ...
    level_design_dir = os.path.join(script_dir, '..', '..')  # Remonte à level_design/
    work_dir = os.path.join(level_design_dir, '..', '..', 'work')  # WIP/work/
...
def load_level_files(folder_name):
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    level_design_dir = os.path.join(script_dir, '..', '..')  # level_design/
    # Chercher dans chests/data/levels/ ou spawns/data/levels/
    if 'chest' in folder_name.lower():
        folder_path = os.path.join(level_design_dir, 'chests', 'data', 'levels')
    else:
        folder_path = os.path.join(level_design_dir, 'spawns', 'data', 'levels')

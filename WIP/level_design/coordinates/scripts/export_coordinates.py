...
OUTPUT_DIR = Path(__file__).parent.parent / "data"  # coordinates/data/
...
def main():
    ...
    for start, size, zone_name, description in zones:
        ...
        if coords:
            ...
            csv_file = OUTPUT_DIR / f"coordinates_{zone_name}.csv"
    ...
    # Export master JSON
    json_file = OUTPUT_DIR / "coordinates_export.json"
    ...
    readme_file = OUTPUT_DIR / "COORDINATE_VISUALIZATION.md"
